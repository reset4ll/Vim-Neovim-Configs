...
-- Soporte específico de lenguajes
-- use 'rust-lang/rust.vim' -- Soporte para Rust
-- use 'vim-python/python-syntax' -- Soporte para Python

vim.cmd('set autoindent') -- Activar indentado automático
vim.cmd('set smartindent') -- Activar indentado inteligente

-- Configuración de LSP
local lspconfig = require('lspconfig')
lspconfig.ccls.setup{} -- Configuración para C/C++
lspconfig.pyright.setup{} -- Configuración para Python
lspconfig.rust_analyzer.setup{} -- Configuración para Rust
